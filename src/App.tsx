            ...
            <>
              ...
              {loading ? (
                ...
                <Routes>
                  ...
                  <Route path="/" element={
                    <>
                      <MediaRow title="Trending This Week" subtitle="Most watched movies and series right now" icon={TrendingUp} items={trending} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Top Rated Masterpieces" subtitle="Critically acclaimed cinema classics" icon={Star} items={topRated} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Popular Movies" subtitle="Blockbuster movies in 1080p Ultra HD" icon={Film} items={popularMovies} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Popular TV Series" subtitle="Binge-worthy shows with full season episodes" icon={Tv} items={popularTV} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                    </>
                  } />
                  ...
                  <Route path="/trending" element={
                    <>
                      <MediaRow title="Trending This Week" subtitle="Most watched movies and series right now" icon={TrendingUp} items={trending} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Trending TV Shows" icon={TrendingUp} items={trending.filter((item) => item.media_type === 'tv' || item.first_air_date)} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                    </>
                  } />
                  ...
                  <Route path="/movies" element={
                    <>
                      <MediaRow title="Popular Movies" icon={Film} items={popularMovies} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Now Playing in Theaters" icon={Popcorn} items={nowPlaying} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Action & Adventure" icon={Flame} items={actionMedia} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Sci-Fi & Fantasy" icon={Rocket} items={sciFiMedia} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Horror & Thrillers" icon={Ghost} items={horrorMedia} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                    </>
                  } />
                  ...
                  <Route path="/tv" element={
                    <>
                      <MediaRow title="Top TV Series" icon={Tv} items={popularTV} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Trending TV Shows" icon={TrendingUp} items={trending.filter((item) => item.media_type === 'tv' || item.first_air_date)} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                      <MediaRow title="Animation & Anime Series" icon={Sparkles} items={animationMedia} onOpenMedia={handleOpenMedia} onPlayMedia={handlePlayMedia} />
                    </>
                  } />
                </Routes>
              )}
